...
tmp = zeros(length(xHis1(:,1)), len-length(xHis1(1,:)));
xHis1 = [xHis1 tmp];
...
subplot(2,5,1);
plot(time',xHis1(13,1:length(time)),'b');
hold on
subplot(2,5,2);
plot(time',xHis1(1,1:length(time)),'b')
hold on
subplot(2,5,3);
plot(time',xHis1(9,1:length(time)),'b')
hold on
subplot(2,5,4);
plot(time',xHis1(10,1:length(time)),'b')
hold on
subplot(2,5,5);
plot(time',xHis1(4,1:length(time)),'b')
hold on
subplot(2,5,6);
plot(time',xHis1(3,1:length(time)),'b')
hold on
subplot(2,5,7);
plot(time',r1(1:length(time)),'b')
hold on
subplot(2,5,8);
plot(time',xHis1(14,1:length(time)),'b')
hold on


subplot(2,5,1);
plot(time',xHis2(13,1:length(time)),'r');
legend('従来法','提案法sim1', '提案法sim2');
grid on
xlabel('Time [s]');
ylabel('xJerk [m/s^3]');
subplot(2,5,2);
plot(time',xHis2(1,1:length(time)),'r')
legend('従来法','提案法sim1', '提案法sim2');
grid on
xlabel('Time [s]');
ylabel('Velocity [m/s]');
subplot(2,5,3);
plot(time',xHis2(9,1:length(time)),'r')
legend('従来法','提案法sim1', '提案法sim2');
grid on
xlabel('Time [s]');
ylabel('Acceleration [m/s^2]');
subplot(2,5,4);
plot(time',xHis2(10,1:length(time)),'r')
legend('従来法','提案法sim1', '提案法sim2');
grid on
xlabel('Time [s]');
ylabel('Lateral acceleration [m/s^2]');
subplot(2,5,5);
plot(time',xHis2(4,1:length(time)),'r')
legend('従来法','提案法sim1', '提案法sim2');
grid on
xlabel('Time [s]');
ylabel('Yaw rate [rad/s]');
subplot(2,5,6);
plot(time',xHis2(3,1:length(time)),'r')
legend('従来法','提案法sim1', '提案法sim2');
grid on
xlabel('Time [s]');
ylabel('Sideslip angle [rad]');
subplot(2,5,7);
plot(time',r2(1:length(time)),'r')
legend('従来法','提案法sim1', '提案法sim2');
grid on
xlabel('Time [s]');
ylabel('d(t)');
subplot(2,5,8);
plot(time',xHis2(14,1:length(time)),'r')
legend('従来法','提案法sim1', '提案法sim2');
grid on
xlabel('Time [s]');
ylabel('yJerk [m/s^3]');
% subplot(2,5,9);
% plot(time',mvHis2(1,1:length(time)),'r')
% legend('従来法','提案法');
% grid on
% xlabel('Time [s]');
% ylabel('inputJerk [m/s^3]');
% subplot(2,5,10);
% plot(time',mvHis2(2,1:length(time)),'r')
% legend('従来法','提案法');
% grid on
% xlabel('Time [s]');
